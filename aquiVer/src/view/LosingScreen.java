...
public class LosingScreen {
    ...
    public LosingScreen(Stage stage, Player player) {
        this.stage = stage;
        this.player = player;
    ...
    private Pane createContent() {
        ...
        Label victoryLabel = new Label("You LOSE!");
        ...
        Label statisticsLabel = new Label("Monsters Killed: " + this.player.getMonstersKilled()
        ...
        statisticsLabel.setTranslateX(175);
        statisticsLabel.setTranslateY(275);
